-- 0006_portal_accounts_and_memberships.sql
-- POC reset: replace tenant-coupled portal_users with personal accounts +
-- tenant memberships. Existing portal data is intentionally discarded.
